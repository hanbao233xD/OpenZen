                ...
                try {
                    if (setting instanceof BooleanSetting booleanSetting) {
                        bufferedWriter.write(String.format((String) "B:%s:%s:%s\n", (Object[]) new Object[] {
                                module.getName(), booleanSetting.getName(), booleanSetting.getValue() }));
                    } else if (setting instanceof NumberSetting numberSetting) {
                        bufferedWriter.write(String.format((String) "F:%s:%s:%s\n", (Object[]) new Object[] {
                                module.getName(), numberSetting.getName(), numberSetting.getValue() }));
                    } else if (setting instanceof ModeSetting modeSetting) {
                        bufferedWriter.write(String.format((String) "M:%s:%s:%s\n", (Object[]) new Object[] {
                                module.getName(), modeSetting.getName(), modeSetting.getValue() }));
                    } else if (setting instanceof MultiSelectSetting multiSelectSetting) {
                        bufferedWriter.write(String.format((String) "MV:%s:%s:%s\n",
                                (Object[]) new Object[] { module.getName(), multiSelectSetting.getName(),
                                        String.join(",", multiSelectSetting.getValue()) }));
                    } else {

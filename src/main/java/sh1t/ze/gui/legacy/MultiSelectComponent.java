...
public class MultiSelectComponent
    ...
    public void renderWithAlpha(PoseStack poseStack, int mouseX, int mouseY, float partialTicks, float alpha) {
        ...
        Color boxColor = hovered && !this.dropdownOpen ? new Color(40, 40, 40, (int) (180.0f * alpha))
                : new Color(15, 15, 15, (int) (220.0f * alpha));
        ...
        float nameY = (float) (rowY + verticalPadding)
                + ((float) contentHeight - FontStore.OPENSANS_16.getFontHeight()) / 2.0f - 1.0f;
        ...
        if (this.dropdownOpen) {
            ...
            for (int i = 0; i < options.size(); ++i) {
                ...
                FontStore.OPENSANS_16.drawStringWithShadow(poseStack, option, optionX, optionY,
    ...
    private boolean isHeaderHovered(double mouseX, double mouseY) {
        ...
        return mouseX >= (double) this.parentButton.panel.x
                ...
                && mouseY >= (double) rowY && mouseY <= (double) (rowY + this.parentButton.panel.rowHeight);
    }
    ...
    public boolean isHovered(double mouseX, double mouseY) {
        ...
        if (this.dropdownOpen) {
            ...
            int boxX = panelX + outerPadding + innerPadding;
            int boxWidth = panelWidth - (outerPadding + innerPadding) * 2;
            return mouseX >= (double) boxX && mouseX <= (double) (boxX + boxWidth) && mouseY >= (double) dropdownY

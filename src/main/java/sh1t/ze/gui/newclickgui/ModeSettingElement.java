...
public class ModeSettingElement
    ...
    public void render(NewClickGui clickGui, GuiGraphics guiGraphics, PoseStack poseStack, int mouseX, int mouseY,
        ...
        if (openAmount > 0.0f) {
            ...
            for (String mode : this.setting.getModes()) {
                ...
                if (dropdownY + dropdownHeight > itemY + FontStore.AXIFORMA_BOLD_13.getFontHeight()) {
                    FontStore.AXIFORMA_BOLD_13.drawStringCentered(poseStack, mode, this.x + 60.0f, itemY,
        ...
        RenderUtil
                .drawRoundedRect(poseStack, this.x + 6.0f, dropdownY, dropdownWidth, itemHeight, 3.0f,
                        ColorUtil.withAlpha(
                                ...
                                alpha));
        FontStore.AXIFORMA_BOLD_13.drawStringCentered(poseStack, this.setting.getValue(), this.x + 60.0f,
        ...
        FontStore.MATERIAL_20.drawStringCentered(poseStack, arrowIcon,
                this.x + 6.0f + dropdownWidth - FontStore.MATERIAL_20.getStringWidth(arrowIcon) + 2.0f,

...
public class ChatScreenPatch {
    ...
    public static void onRender(ChatScreen screen, GuiGraphics graphics, int mouseX, int mouseY, float partialTick,
            CallbackInfo callbackInfo) {
        try {
            for (HudElement element : ZenClient.getInstance().getHudManager().getHudElements().stream()

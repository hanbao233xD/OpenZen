...
public class PlayerTabOverlayPatch extends ClientBase {
    ...
    @Transform(method = "render", desc = "(Lnet/minecraft/client/gui/GuiGraphics;ILnet/minecraft/world/scores/Scoreboard;Lnet/minecraft/world/scores/Objective;)V")
    ...
    @Inject(method = "render", desc = "(Lnet/minecraft/client/gui/GuiGraphics;ILnet/minecraft/world/scores/Scoreboard;Lnet/minecraft/world/scores/Objective;)V", at = @At(At.Type.HEAD))
    public static void onRenderPre(PlayerTabOverlay overlay, GuiGraphics graphics, int width, Scoreboard scoreboard,
            Objective objective, CallbackInfo callbackInfo) {
        try {
            TabListInfo.header = (Component) ReflectionUtil.getStaticField(overlay, "header",
                    "net/minecraft/client/gui/components/PlayerTabOverlay");
            TabListInfo.footer = (Component) ReflectionUtil.getStaticField(overlay, "footer",
                    "net/minecraft/client/gui/components/PlayerTabOverlay");
        ...
        if (watermark == null || !watermark.isEnabled() || !mc.options.keyPlayerList.isDown())
            return;
        try {
    ...
    @Inject(method = "render", desc = "(Lnet/minecraft/client/gui/GuiGraphics;ILnet/minecraft/world/scores/Scoreboard;Lnet/minecraft/world/scores/Objective;)V", at = @At(At.Type.TAIL))
    public static void onRenderPost(PlayerTabOverlay overlay, GuiGraphics graphics, int width, Scoreboard scoreboard,
            Objective objective, CallbackInfo callbackInfo) {
        if (renderState.get()) {

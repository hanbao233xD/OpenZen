...
public class ItemInHandRendererPatch {
    @WrapInvoke(method = "tick", desc = "()V", target = "net/minecraft/world/entity/LivingEntity/getMainHandItem", targetDesc = "()Lnet/minecraft/world/item/ItemStack;")
    public static ItemStack onGetMainHandItem(ItemInHandRenderer renderer,
            Invocation<ItemInHandRenderer, ItemStack> original) {
        UpdateHeldItemEvent event = new UpdateHeldItemEvent(InteractionHand.MAIN_HAND,
    ...
    @Inject(method = "renderArmWithItem", desc = "(Lnet/minecraft/client/player/AbstractClientPlayer;FFLnet/minecraft/world/InteractionHand;FLnet/minecraft/world/item/ItemStack;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;I)V", at = @At(At.Type.HEAD))

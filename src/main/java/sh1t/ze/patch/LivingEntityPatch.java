...
public class LivingEntityPatch {
    ...
    private static boolean shouldFastDig(LivingEntity entity) {
        ...
        if (noDelay == null || !noDelay.isEnabled() || !noDelay.fastDig.getValue())
            return false;
    ...
    public static boolean overwriteHasEffect(LivingEntity entity, MobEffect effect) throws Exception {
        ...
        Map<MobEffect, MobEffectInstance> activeEffects = (Map<MobEffect, MobEffectInstance>) ReflectionUtil
                .getStaticField(entity, "activeEffects", "net/minecraft/world/entity/LivingEntity");
    ...
    public static float onTickHeadTurn(LivingEntity entity, float yaw, float partial,
            Invocation<LivingEntity, Float> original) throws Exception {
    ...
    public static void onTravel(LivingEntity entity, Vec3 movement, CallbackInfo callbackInfo) throws Exception {
        if (entity == null || entity != ClientBase.mc.player || !ZenClient.isReady())
            return;
    ...
    public static float onTravelGetXRot(LivingEntity entity, Vec3 movement, Invocation<LivingEntity, Float> original)
            throws Exception {

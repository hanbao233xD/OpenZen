...
public class LocalPlayerPatch {
    ...
    public static MotionEvent onMotion(double x, double y, double z, float yaw, float pitch, boolean onGround,
            boolean isPost) {
    ...
    public static void transformAiStep(MethodNode methodNode) {
        ...
        for (AbstractInsnNode insn : methodNode.instructions) {
            if (insn instanceof MethodInsnNode methodInsn
                    && methodInsn.name
                            .equals(ReflectionUtil.getMappedMethodName(LocalPlayer.class, "isUsingItem", "()Z"))
    ...
    @Inject(method = "tick", desc = "()V", at = @At(value = At.Type.BEFORE_INVOKE, method = "net/minecraft/client/player/AbstractClientPlayer/tick", desc = "()V"))
    ...
    private static void redirectToEventField(MethodNode methodNode, AbstractInsnNode callInsn, int index, String field,
            String desc) {

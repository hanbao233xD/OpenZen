...
public class RoundTargetStyle
    ...
    @Override
    public void render(Render2DEvent render2DEvent, LivingEntity livingEntity, SmoothAnimationTimer healthAnim,
        ...
        Renderer.renderConsumer((drawContext -> {
            ...
            if (target instanceof AbstractClientPlayer abstractClientPlayer) {
                GlHelper.drawPlayerHeadRounded(abstractClientPlayer, headX, headY, headSize, headSize, fade,
                        5.0f * combinedScale);
            }
            ...
            GlHelper.drawTextShadowLegacy(displayName, contentX, nameY + 1.0f + slideOff, this.nameFont,
                    new Color(1.0f, 1.0f, 1.0f, fade).getRGB());
            ...
            this.healthLagPaint
                    .setColor(new Color(99, 99, 99, (int) ((float) COLOR_HEALTH_LAG.getAlpha() * fade)).getRGB());
            ...
            Color barColor2 = new Color(COLOR_HEALTH_BAR2.getRed(), COLOR_HEALTH_BAR2.getGreen(),
                    COLOR_HEALTH_BAR2.getBlue(), (int) (255.0f * fade));

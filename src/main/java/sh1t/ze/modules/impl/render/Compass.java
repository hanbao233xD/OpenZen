...
public class Compass
    ...
    private void draw(DrawContext drawContext) {
        ...
        float angle = (float) (Math.toDegrees(Math.atan2((double) this.spawnPosition.getZ() - this.renderZ,
                (double) this.spawnPosition.getX() - this.renderX)) - 90.0 - (double) this.renderYaw);

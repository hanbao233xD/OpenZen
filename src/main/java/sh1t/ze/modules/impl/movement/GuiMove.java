...
public class GuiMove
    ...
    public void onStrafe(StrafeEvent strafeEvent) {
        ...
        strafeEvent.setForward(
                GuiMove.getMovementSpeed(this.isMovementKey(mc.options.keyUp), this.isMovementKey(mc.options.keyDown)));
        strafeEvent.setStrafe(GuiMove.getMovementSpeed(this.isMovementKey(mc.options.keyLeft),
                this.isMovementKey(mc.options.keyRight)));
    }

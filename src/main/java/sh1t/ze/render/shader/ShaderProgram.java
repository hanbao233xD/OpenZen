...
public class ShaderProgram {
    ...
    public ShaderProgram(String name, Supplier<Map<Integer, String>> attributesSupplier, String modelViewName,
            String projName) {
    ...
    public ShaderProgram(String fragmentName, String vertexName, Supplier<Map<Integer, String>> attributesSupplier,
        ...
        int fragmentShader = ShaderProgram.compileShader(ShaderSource.getByFileName(fragmentName + ".fsh").getSource(),
                35632);
        int vertexShader = ShaderProgram.compileShader(ShaderSource.getByFileName(vertexName + ".vsh").getSource(),
                35633);
    ...
    private static int compileShader(String source, int type) {
        ...
        if (GL20.glGetShaderi(shader, 35713) == 0) {
            ...
            throw new IllegalStateException(
                    String.format("Failed to compile shader! (Type: %s)", new Object[] { type }));
        }
        return shader;
    }

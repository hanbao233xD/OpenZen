...
public final class TextGlow {
    ...
    public static void drawBackground(PoseStack poseStack, float x, float y, float width, float height, float radius,
            float alpha) {
        ...
        RenderUtil.drawRoundedRect(poseStack, x, y, width, height, radius,
                new Color(255, 255, 255, lightAlpha).getRGB());
    }

    public static float drawGlowText(String text, float x, float y, FontRenderer fontRenderer, int color, int glowColor,
            float radius) {

...
public class EntityUtil
    ...
    public static AABB getInterpolatedAABB(Entity entity, float partialTicks) {
        ...
        return new AABB(pos.x - halfWidth, pos.y, pos.z - halfWidth, pos.x + halfWidth,
                pos.y + (double) entity.getBbHeight(), pos.z + halfWidth);
    }
    ...
    private static Vector4d getScreenBoundsInternal(int[] viewport, AABB aABB, Matrix4f mvpMatrix) {
        List<Vec3> corners = Arrays.asList(new Vec3(aABB.minX, aABB.minY, aABB.minZ),
                new Vec3(aABB.minX, aABB.maxY, aABB.minZ), new Vec3(aABB.maxX, aABB.minY, aABB.minZ),
                new Vec3(aABB.maxX, aABB.maxY, aABB.minZ), new Vec3(aABB.minX, aABB.minY, aABB.maxZ),
                new Vec3(aABB.minX, aABB.maxY, aABB.maxZ), new Vec3(aABB.maxX, aABB.minY, aABB.maxZ),
    ...
    public static Vector3f getCameraRelativePos(Entity entity, float partialTicks) {
        ...
        Vector3f relativePos = new Vector3f((float) (entityX - cameraPos.x), (float) (entityY - cameraPos.y),

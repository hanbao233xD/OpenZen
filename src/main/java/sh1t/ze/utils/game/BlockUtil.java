...
public final class BlockUtil
    ...
    public static boolean isSolid(Block block) {
        ...
        return !(block instanceof LiquidBlock) && !(block instanceof AirBlock) && !(block instanceof ChestBlock)
                ...
                && !(block instanceof LadderBlock) && !(block instanceof TntBlock);
    }
    ...
    public static BlockPos getOffsetPos(BlockPos blockPos, double dx, double dy, double dz) {
        return new BlockPos((int) Math.floor((double) blockPos.getX() + dx),
                (int) Math.floor((double) blockPos.getY() + dy), (int) Math.floor((double) blockPos.getZ() + dz));
    }

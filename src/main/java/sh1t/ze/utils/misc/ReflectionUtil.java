...
public final class ReflectionUtil {
    ...
    private static final Object2ObjectMap<String, MethodHandles.Lookup> lookupCache = new Object2ObjectOpenHashMap<>(
            500);
    ...
    public static void setJumpDelay(int delay) {
        if (ClientBase.mc == null || ClientBase.mc.player == null)
            return;
    ...
    public static float getYRot(ServerboundMovePlayerPacket packet) {
        if (ClientBase.mc.gameMode == null)
            return 0.0f;
    ...
    private static ObjectLongPair<Object> getStaticFieldPair(Class<?> clazz, String name) {
        ...
        try {
            ...
            ObjectLongPair<Object> p = new ObjectLongImmutablePair<>(unsafe.staticFieldBase(field),

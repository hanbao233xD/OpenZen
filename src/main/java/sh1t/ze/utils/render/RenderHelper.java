...
public final class RenderHelper {
    public static void blitRenderTarget(RenderTarget renderTarget, PoseStack poseStack, int width, int height) {
        ...
        bufferBuilder.vertex(matrix4f, (float) width, (float) height, 0.0f).uv(uMax, 0.0f).color(255, 255, 255, 255)
                .endVertex();
    ...
    public static void setShaderColorWithAlpha(int color, int alpha) {
        RenderSystem.setShaderColor((float) ColorUtil.getRed(color) / 255.0f,
                (float) ColorUtil.getGreen(color) / 255.0f, (float) ColorUtil.getBlue(color) / 255.0f,
                (float) alpha / 255.0f);
    }
    ...
    public static void setShaderColorComponents(int color) {
        RenderHelper.setShaderColorRGBA(ColorUtil.getRed(color), ColorUtil.getGreen(color), ColorUtil.getBlue(color),
